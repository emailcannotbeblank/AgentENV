    ...
    E: std::fmt::Debug + Send + Sync + 'static,
{
    ...
    let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::sandboxes::SandboxesSandboxIdCpuAffinityPostResponse::Status200_CPUAffinityAppliedAndVerifiedSuccessfully
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
                                                ...
                                                apis::sandboxes::SandboxesSandboxIdCpuAffinityPostResponse::Status400_BadRequest
                                                    (body)
                                                => {
                                                  let mut response = response.status(400);
                                                  {
                                                ...
                                                apis::sandboxes::SandboxesSandboxIdCpuAffinityPostResponse::Status403_Forbidden
                                                    (body)
                                                => {
                                                ...
                                                apis::sandboxes::SandboxesSandboxIdCpuAffinityPostResponse::Status409_Conflict
                                                    (body)
                                                => {
                                                  let mut response = response.status(409);
                                                  {
                                                ...
                                                apis::sandboxes::SandboxesSandboxIdCpuAffinityPostResponse::Status404_NotFound
                                                    (body)
                                                => {
                                                  let mut response = response.status(404);
                                                  {
                                                ...
                                                apis::sandboxes::SandboxesSandboxIdCpuAffinityPostResponse::Status401_AuthenticationError
                                                    (body)
                                                => {
                                                  let mut response = response.status(401);
                                                  {
                                                ...
                                                apis::sandboxes::SandboxesSandboxIdCpuAffinityPostResponse::Status500_ServerError
                                                    (body)
                                                => {
                                                  let mut response = response.status(500);
                                                  {
                                                ...
                                                apis::sandboxes::SandboxesSandboxIdCpuAffinityPostResponse::Status503_ServiceUnavailable
                                                    (body)
                                                => {
